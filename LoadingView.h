...
- (void)startLoading;
- (id)initWithScreenHeight:(float)arg1 loadingText:(id)arg2 successText:(id)arg3;
- (id)initWithFrame:(struct CGRect)arg1 loadingText:(id)arg2 successText:(id)arg3;
- (void)setupConstraints;
- (id)initWithFrame:(struct CGRect)arg1 textColor:(id)arg2 textFont:(id)arg3 backgroundColor:(id)arg4 loadingIndicatorStyle:(int)arg5 loadingText:(id)arg6 successText:(id)arg7;

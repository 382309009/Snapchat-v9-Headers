...
@class NSString, UITextView, UIToolbar, UIView;

@interface SCCaptionBigTextView : NSObject <UITextViewDelegate, SCCaption>
{
...
@property(retain, nonatomic) UIView *captionBackgroundView; // @synthesize captionBackgroundView=_captionBackgroundView;
...
- (void)adjustFontSizeToFitTextIfNecessary:(id)arg1;

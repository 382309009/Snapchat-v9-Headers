...
+ (id)adapterVersion;
@property(nonatomic) __weak id <GADMAdNetworkConnector><GADMAdNetworkConnectorCOPPAField> connector; // @synthesize connector=_connector;

...
@interface GADSlot : NSObject <GADActiveViewMonitorDelegate, GADWebViewActiveViewMonitoring, GADPercentDrivenUserInteractionAnimationControllerDelegate, GADSDKCoreControllerDelegate, SKStoreProductViewControllerDelegate, GADSlotAdResponseDelegate, GADAdFetcherDelegate>
{
    int _state;
...
@property(nonatomic, getter=isReloadable) BOOL reloadable; // @synthesize reloadable=_reloadable;
...
- (void)loadRequest:(id)arg1 autoRefresh:(BOOL)arg2;

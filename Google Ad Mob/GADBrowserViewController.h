...
@property(retain, nonatomic) UIBarButtonItem *forwardButtonDisabled; // @synthesize forwardButtonDisabled=_forwardButtonDisabled;
@property(retain, nonatomic) UIBarButtonItem *forwardButton; // @synthesize forwardButton=_forwardButton;
@property(retain, nonatomic) UIBarButtonItem *backButtonDisabled; // @synthesize backButtonDisabled=_backButtonDisabled;

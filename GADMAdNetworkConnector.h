...
@property(nonatomic, getter=isClicked) BOOL clicked; // @synthesize clicked=_clicked;
@property(nonatomic) BOOL didNetworkRefresh; // @synthesize didNetworkRefresh=_didNetworkRefresh;

...
- (id)didUpdateNotificationUserInfoWithUpdateType:(unsigned int)arg1 chunk:(id)arg2 success:(id)arg3 error:(id)arg4;
- (void)postDidFinishLoadingChunkNotificationWithChunk:(id)arg1 success:(BOOL)arg2 error:(id)arg3;

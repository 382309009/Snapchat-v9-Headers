...
@interface SelectFriendsViewController : UIViewController <SCSearchBarDelegate, UITableViewDelegate, UITableViewDataSource, FriendsTableIndexDelegate, UITextFieldDelegate>
{
...
@property(nonatomic) BOOL searchBarNeedsTopBottomBorders; // @synthesize searchBarNeedsTopBottomBorders=_searchBarNeedsTopBottomBorders;

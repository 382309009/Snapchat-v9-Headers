...
@interface BCOV_RACTestScheduler : BCOV_RACScheduler
{
    ...
    unsigned int _numberOfDirectlyScheduledBlocks;
}

@property(nonatomic) unsigned int numberOfDirectlyScheduledBlocks; // @synthesize numberOfDirectlyScheduledBlocks=_numberOfDirectlyScheduledBlocks;
